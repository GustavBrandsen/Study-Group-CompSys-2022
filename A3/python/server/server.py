    ...
    def handle(self):
        ...
        try:
            ...
            signature = bytes_message[
                LEN_USERNAME:LEN_USERNAME+LEN_SIGNATURE
            ]
            request_length = struct.unpack('!I', bytes_message[
                LEN_USERNAME+LEN_SIGNATURE:LEN_USERNAME+LEN_SIGNATURE+LEN_REQUEST_LENGTH
            ])[0]
            request = bytes_message[
                LEN_USERNAME+LEN_SIGNATURE+LEN_REQUEST_LENGTH:LEN_USERNAME+LEN_SIGNATURE+LEN_REQUEST_LENGTH
                + request_length
            ]
